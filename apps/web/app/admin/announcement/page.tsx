...
export default function AnnouncementPage() {
  ...
  const [announcements, setAnnouncements] = useState([
    { id: 1, title: 'Holiday Hours Notice', content: 'Our clinic will be operating on reduced hours during the upcoming holiday weekend.', status: 'published', date: 'Oct 25, 2024' },
    { id: 2, title: 'New Vaccination Drive', content: 'Join us next week for a discounted rabies vaccination drive for all registered pets.', status: 'published', date: 'Oct 20, 2024' },
  ]);
                ...
                {isComposing && (
                    <div style={{ flex: '1.5', width: '100%', position: 'sticky', top: '20px' }}>
                        <div className="compose-area" style={{ background: 'white', padding: '30px', borderRadius: '16px', boxShadow: '0 10px 30px rgba(0,0,0,0.08)', border: '1px solid #edf2f7' }}>
                            ...
                            <input type="text" id="newAnnouncementTitle" placeholder="Enter formal title..." style={{ width: '100%', padding: '12px 15px', border: '1px solid #cbd5e0', borderRadius: '8px', marginBottom: '20px', fontSize: '1rem', fontFamily: 'serif' }} />
                            
                            <label style={{ display: 'block', marginBottom: '8px', color: '#4a5568', fontWeight: 600, fontSize: '0.9rem' }}>Document Content</label>
                            <textarea id="newAnnouncementContent" rows={10} placeholder="Type announcement body here..." style={{ width: '100%', padding: '15px', border: '1px solid #cbd5e0', borderRadius: '8px', marginBottom: '25px', fontSize: '1rem', resize: 'vertical', lineHeight: '1.6' }}></textarea>
                            ...
                            <div className="compose-actions" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #edf2f7', paddingTop: '20px' }}>
                                <select id="newAnnouncementStatus" style={{ padding: '10px 15px', border: '1px solid #cbd5e0', borderRadius: '8px', background: '#f7fafc', cursor: 'pointer', fontWeight: 500 }}>
                                ...
                                <div style={{ display: 'flex', gap: '12px' }}>
                                    ...
                                    <button className="btn-primary" onClick={() => { setIsComposing(false); }} style={{ padding: '10px 24px', background: 'linear-gradient(135deg, #2E5E3E 0%, #1a4d2e 100%)', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '8px', boxShadow: '0 4px 12px rgba(46, 94, 62, 0.2)' }}>
