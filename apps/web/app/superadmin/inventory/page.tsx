...
export default function InventoryPage() {
  ...
  const saveItem = () => {
    ...
    if (!newItem.stock) errors.stock = "Stock Quantity is required";
    if (!newItem.price) errors.price = "Unit Price is required";
    if (isMedOrVac) {
      if (!newItem.dosageForm) errors.dosageForm = "Dosage Form is required";
      if (!newItem.expiryDate) errors.expiryDate = "Expiration Date is required";
    }
        ...
        <form className="inv-modal-body" onSubmit={(e) => { e.preventDefault(); saveItem(); }}>
          ...
          <div className="inv-form-grid">
            <div className="inv-field-group">
              ...
              />
              {validationErrors.name && <span className="inv-error-msg"><i className="fas fa-exclamation-circle"></i> {validationErrors.name}</span>}
            </div>
            ...
            <div className="inv-field-group">
              ...
              {validationErrors.category && <span className="inv-error-msg"><i className="fas fa-exclamation-circle"></i> {validationErrors.category}</span>}
            </div>
          </div>
          ...
          <div className="inv-field-group">
            ...
            />
            {validationErrors.description && <span className="inv-error-msg"><i className="fas fa-exclamation-circle"></i> {validationErrors.description}</span>}
          </div>

          {/* Conditional: Dosage Form + Expiry Date (Med/Vaccine only) */}
          {(normalizeCategorySlug(newItem.category) === 'medications' || newItem.category === 'Vaccine') && (
            <div className="inv-form-grid">
              <div className="inv-field-group">
                <label className="inv-field-label">
                ...
                />
                {validationErrors.dosageForm && <span className="inv-error-msg"><i className="fas fa-exclamation-circle"></i> {validationErrors.dosageForm}</span>}
              </div>
              ...
              <div className="inv-field-group">
                ...
                />
                {validationErrors.expiryDate && <span className="inv-error-msg"><i className="fas fa-exclamation-circle"></i> {validationErrors.expiryDate}</span>}
              </div>
            </div>
          )}
          ...
          <div className="inv-form-grid">
            <div className="inv-field-group">
              ...
              {validationErrors.stock && <span className="inv-error-msg"><i className="fas fa-exclamation-circle"></i> {validationErrors.stock}</span>}
            </div>
            ...
            <div className="inv-field-group">
              ...
              {validationErrors.price && <span className="inv-error-msg"><i className="fas fa-exclamation-circle"></i> {validationErrors.price}</span>}
            </div>
          </div>
