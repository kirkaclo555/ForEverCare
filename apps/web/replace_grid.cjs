...
const split1 = content.split('<div className="dashboard-grid">');
const split2 = split1[1].split('<div className="modal" id="generalSettingsModal"');

const newGrid = `<div className="dashboard-grid">
...
const newContent = split1[0] + newGrid + split2[1];
fs.writeFileSync(filePath, newContent, 'utf8');
console.log("Successfully replaced calendar grid.");
